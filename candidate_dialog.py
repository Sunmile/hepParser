...
from spectra_tools_fix import get_first_max_num
...
class Ui_QWDialogSize(object):
    ...
    def setupUi(self, QWDialogSize):
        ...
        QWDialogSize.setWindowTitle(_translate("QWDialogSize", "Component list"))
        QWDialogSize.setWindowModality(QtCore.Qt.NonModal)
        QWDialogSize.resize(550, 400)
        ...
        self.comp_label.setText(_translate("MainWindow", '  Component'))
        ...
        self.selectAll_chk = QCheckBox("Check all")
        ...
        self.select_addvise_chk = QCheckBox("Recommend")
...
class QAnalyseBar(QDialog):
    ...
    def initUI(self):
        self.setWindowTitle("Analysing the components")
        self.setWindowModality(Qt.NonModal)
        screen = QDesktopWidget().screenGeometry()
        windowSize = self.geometry()
        # self.move((screen.width() - windowSize.width()), (screen.height() - windowSize.height()) / 2)
        self.resize(310, 140)
        ...
        self.precess_info = QLabel("Analysis of components")
